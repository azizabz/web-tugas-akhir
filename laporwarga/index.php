...
<head>
	...
	<title>Aplikasi Lapor Kejahatan Jalanan</title>
...
?>
                            ...
                            <p>Hallo User<br>Silahkan login terlebih dahulu untuk dapat menggunakan fitur yang ada pada Aplikasi Lapor Warga.</p>
...
?>
                            <div class="content text-center simple-text">
                            <h4>Selamat Datang</h4>
                            <p>Hallo <?php echo $_SESSION['nama_user'] ?><br>Selamat datang di Aplikasi Lapor Warga. Anda dapat menggunakan fitur yang tersedia pada aplikasi.</p>
                            </div>
...
?>
                            <div class="content text-center simple-text">
                            <h4>Selamat Datang</h4>
                            <p>Hallo <?php echo $_SESSION['nama_admin'] ?><br>Selamat datang di Aplikasi Lapor Warga. Anda dapat menggunakan fitur yang tersedia pada aplikasi.</p>
                            </div>
